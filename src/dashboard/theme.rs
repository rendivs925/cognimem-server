...
// Based on Aura theme by Josean Martinez
...
impl Theme {
    ...
    pub fn to_css_vars(&self) -> String {
        format!(
            ...
            self.bg, self.fg, self.accent, self.primary, self.muted, self.warning, self.error, self.success
        )
    }
...
.sidebar{{width:{w};background:linear-gradient(180deg,rgba(33,73,105,.3),rgba(1,20,35,.8));border-right:1px solid var(--muted);padding:24px 16px}}
...
.nav-item:hover{{background:rgba(33,73,105,.3)}}
.nav-item.active{{background:linear-gradient(90deg,rgba(71,255,156,.15),transparent);color:var(--accent);border-left:2px solid var(--accent)}}
...
.stat-card{{background:linear-gradient(135deg,rgba(33,73,105,.2),rgba(1,20,35,.4));border:1px solid var(--muted);border-radius:{r};padding:24px}}
...
.card{{background:linear-gradient(135deg,rgba(33,73,105,.15),rgba(1,20,35,.3));border:1px solid var(--muted);border-radius:{r};overflow:hidden}}
...
.table td{{padding:16px 24px;border-bottom:1px solid rgba(33,73,105,.3)}}
.table tr:hover{{background:rgba(33,73,105,.2)}}
...
code{{font-family:'JetBrains Mono',monospace;background:rgba(33,73,105,.3);padding:2px 8px;border-radius:4px;font-size:12px}}
"#,
